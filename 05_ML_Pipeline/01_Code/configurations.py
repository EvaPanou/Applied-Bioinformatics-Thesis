...
-----------------------------------------------------------------------------
WHAT THIS FILE DOES:
  It contains all the commands for configured parameters, paths, or column names
  that you will need to have imported for the main pipeline script to run.

  The rest of the scripts then write  `from configurations import *` so they
...
CODE_DIR     = Path(__file__).resolve().parent      # CODE_DIR = 05_ML_Pipeline/01_Code
PIPELINE_DIR = CODE_DIR.parent                       # PIPELINE_DIR = 05_ML_Pipeline
OUTPUT_DIR   = PIPELINE_DIR / "02_Output"
...
# File names/paths 
# ------------------
INPUT_FILE   = "00_ML_Input_File.tsv"
PIPELINE_LOG = "03_pipeline_log.txt"

DATA_PATH    = PIPELINE_DIR / INPUT_FILE
FIGURES_DIR  = OUTPUT_DIR             # no separate "figures" subfolder - figures save straight into 02_Output
LOG_PATH     = OUTPUT_DIR / PIPELINE_LOG
...
LASSO_C_VALUES = (0.001, 0.01, 0.1, 1.0, 10.0)      # C is the official scikit-learn name for the regularisation strength
...
XGB_LEARN_VALUES       = (0.01, 0.05, 0.1)
