...
[\[06\] Machine_Learning_Preparation](../[06]%20Machine_Learning_Preparation/).
...
- Metadata columns from `GSE108497_updated_metadata_II.csv`.  
  ...
  ([step \[02\] Metadata](../[02]%20Metadata/01_Metadata_Assembly/)).
...
- DEG expression features from `ML_FeatureMatrix_AllDEGs_log2.tsv`.  
  ...
  ([step \[04\] LIMMA_DE_analysis](../[04]%20LIMMA_DE_analysis/DE_Genes/)).
