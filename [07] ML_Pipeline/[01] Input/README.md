...
[[06] Machine_Learning_Preparation](../%5B06%5D%20Machine_Learning_Preparation/).
...
- Metadata columns from `GSE108497_updated_metadata_II.csv`.  
  ...
  ([step [02] Metadata](../%5B02%5D%20Metadata/01_Metadata_Assembly/)).

- DEG expression features from `ML_FeatureMatrix_AllDEGs_log2.tsv`.  
  This expression matrix contains log₂-transformed expression values for all 212 genes identified as Differentially Expressed
  Genes (DEGs) during the LIMMA analysis 
  ([step [04] LIMMA_DE_analysis](../%5B04%5D%20LIMMA_DE_analysis/DE_Genes/)).
